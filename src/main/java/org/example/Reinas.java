...
public class Reinas extends JPanel
{
    ...
    public Reinas ()
    {
        ...
        botonRegresar.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                SwingUtilities.getWindowAncestor(Reinas.this).dispose(); // Cierra la ventana que contiene este panel
    ...
    {
        // Crear un JFrame para contener el panel Reinas
        JFrame frame = new JFrame("Problema de las Reinas");
        ...
        frame.add(new Reinas()); // Agregar el panel Reinas al JFrame
